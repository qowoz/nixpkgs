...
mapAliases {
  ...
  linux_zen = throw "linux_zen has been removed due to lack of maintenance"; # Added 2026-09-10
  ...
  linuxPackages_zen = throw "linuxPackages_zen has been removed due to lack of maintenance"; # Added 2026-09-10
